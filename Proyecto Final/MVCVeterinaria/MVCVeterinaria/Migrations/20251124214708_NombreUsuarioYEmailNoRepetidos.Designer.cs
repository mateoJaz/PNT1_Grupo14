...
namespace MVCVeterinaria.Migrations
{
    ...
    [Migration("20251124214708_NombreUsuarioYEmailNoRepetidos")]
    partial class NombreUsuarioYEmailNoRepetidos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MVCVeterinaria.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MVCVeterinaria.Models.Turno", b =>
                {
                    b.HasOne("MVCVeterinaria.Models.Cliente", null)
                        .WithMany("Turnos")
                        .HasForeignKey("ClienteId");
